...
const BASE_CACHE_FILES = [
    'https://ajudem.cat/wp-content/uploads/ajudemcat_192.png',
'https://ajudem.cat/wp-content/uploads/ajudemcat_512.png',

];

const OFFLINE_CACHE_FILES = [
     'https://ajudem.cat/?amp=1',
];
...
const OFFLINE_PAGE = 'https://ajudem.cat/?amp=1';
const NOT_FOUND_PAGE = 'https://ajudem.cat/?amp=1';
...
//    (str) => {
//        return !str.includes('/wp-admin/') || !str.startsWith('https://ajudem.cat//wp-admin/');
//    },
];
